...
describe('função fatorial', () => {
  test('valida entrada', () => {
    ...
    expect(() => fatorial("10")).toThrow("O argumento deve ser um número válido");
...
describe('função fibonacci', () => {
  test('valida entrada', () => {
    ...
    expect(() => fibonacci("10")).toThrow("O argumento deve ser um número válido");
...
describe('função ehPrimo', () => {
  test('valida entrada', () => {
    ...
    expect(() => ehPrimo("10")).toThrow("O argumento deve ser um número válido");
